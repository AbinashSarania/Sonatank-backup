// src/pages/jeweller/JewellerProfile.jsx

import React, { useState, useEffect } from "react";
import { editJewellerDetails } from "../../api/jewellerAPI"; // Import the new API function
...
const JewellerProfile = () => {
  ...
  const handleSave = async () => {
    try {
      // Call the editJewellerDetails API function
      await editJewellerDetails(formData);
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        {isEditing ? (
          <div>
            {/* Edit Form */}
            <div className="mb-4">
              <label className="text-lg font-semibold text-gray-800">Store Name:</label>
              <input
                type="text"
                name="storeName"
            ...
            <div className="mb-4">
              <label className="text-lg font-semibold text-gray-800">Store Owner Name:</label>
              <input
                type="text"
                name="storeOwnerName"
            ...
            <div className="mb-4">
              <label className="text-lg font-semibold text-gray-800">State:</label>
              <input
                type="text"
                name="state"
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-600">{profileData.storeName || 'N/A'}</p>
            </div>
            <div className="mb-4">
              <h2 className="text-lg font-semibold text-gray-800">Store Owner Name:</h2>
              <p className="text-gray-600">{profileData.storeOwnerName || 'N/A'}</p>
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-600">{profileData.state || 'N/A'}</p>
            </div>
            <div className="mb-4">
              <h2 className="text-lg font-semibold text-gray-800">City:</h2>
              <p className="text-gray-600">{profileData.city || 'N/A'}</p>
            </div>
