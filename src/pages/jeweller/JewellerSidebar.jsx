  ...
  const links = [
    {
      ...
      icon: <HiOutlineShoppingCart />, // Use a relevant icon for Product Management
    },
    {
      to: "jeweller-orders",
      label: "Manage Orders",
              ...
              <li key={to}>
                <Link
                  ...
                  className={`flex items-center p-3 text-sm font-medium rounded-md transition-all ${
                    location.pathname.startsWith(`/jeweller/${to}`)
...
export default JewellerSidebar;
