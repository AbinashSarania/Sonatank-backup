...
import signupImage from "../../assets/images/auth-images (5).jpeg"; // Adjust the path to your image
...
const AdminSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the API function to sign up an admin
      ...
      setErrorMessage(error.error || "Failed to create admin");
